...
public class ImageHandler {
    ...
    public static void getImageFromPathBytes(String path, final ImageView imageView) {
        StorageReference islandRef = FirebaseHelper.mainStorage.getReference().child(path);
